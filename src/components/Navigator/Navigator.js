...
import { setNavigatorPosition, setNavigatorShape } from '../../state/ducks/navigator/actions';
import { setCategoryFilter } from '../../state/ducks/actionBar/actions';
...
const mapStateToProps = (state, ownProps) => {
  return {
    navigatorPosition: state.navigator.navigatorPosition,
    navigatorShape: state.navigator.navigatorShape,
    navigatorShow: state.navigator.navigatorShow,
    isWideScreen: state.actionBar.isWideScreen,
    categoryFilter: state.actionBar.categoryFilter
  };
};
